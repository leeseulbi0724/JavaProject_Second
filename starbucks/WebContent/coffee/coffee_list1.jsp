...
section.coffee_wrap div.box_bg {
	...
	<div id= "container">
		<div class="wn_cont">
			...
			<section class="coffee_wrap">
                   <div class="box_bg">
                        <h3 class="coffee_beans1"><a class="on" href="">스타벅스 원두</a></h3>
                        <h3 class="coffee_beans2"><a href="">스타벅스 비아</a></h3>
        				<h3 class="coffee_beans3"><a href="">스타벅스 오리가미</a></h3>                   
        			</div>
        			<div class="check">
