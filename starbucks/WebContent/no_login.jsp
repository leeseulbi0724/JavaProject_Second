...
<style>
	...
	section div:last-child>p:nth-child(2) { font-size:14px; position:relative; bottom:20px; }
...
<body>
	...
	<!--  content -->
	<section>
		<div><img src="http://localhost:9000/starbucks/images/icon_com_lock.png"></div>
		<div></div>
		<div><p><span style="color:green">로그인</span>시 이용 가능합니다.</p>
