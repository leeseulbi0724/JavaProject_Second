	...
	<div class="drink_detail">
		...
		<div class="content"><!-- 내용 -->
			<div>
				<div class="image"><!-- 이미지 -->
					<div><!-- 큰 이미지 -->
						<img class="zoomImg" src="http://localhost:9000/starbucks/images/cold_brew01_1.jpg">
				...
				<div class="inform"><!-- 정보 -->
					<div><!-- 정보 타이틀 -->
						...
						<div></div>
						<span>부드러운 목넘김의 나이트로 커피와 바닐라 크림의 매력을 한번에 느껴보세요!</span>
					</div><!-- 정보 타이틀 -->
					<div><!-- 정보 내용 -->
						<div>
							<span>제품 영양 정보</span>
